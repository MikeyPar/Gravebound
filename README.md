...
[`GB-M03-04G`](docs/milestones/GB-M03-04G-audit.md), parent [`GB-M03-04`](docs/milestones/GB-M03-04-audit.md), and persistence slice [`GB-M03-02C`](docs/milestones/GB-M03-02C-audit.md) are complete. Hosted real-QUIC/PostgreSQL proof passed the complete typed lifecycle, restart/replay/adverse matrix, 25 journeys at a 10.083 ms median login-to-control, zero idle transactions, and the optimized native evidence matrix. Continue [`GB-M03-06A`](docs/tasks/GB-M03-06A.md) with [`GB-M03-02D`](docs/tasks/GB-M03-02D.md): additive migration `0031`, immutable death/summary/memorial/trace records, danger-entry Equipped/Belt risk capture, and the transactional repository boundary. Keep player-visible death, successor, extraction/Recall, normal Character Select `Play`, Realm Gate/Vault/Memorial station admission, Overflow/ResolutionHold, Core promotion, and the normal route fail closed until their owners pass.
