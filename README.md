...
Parents [`GB-M03-02`](docs/milestones/GB-M03-02-audit.md), [`GB-M03-04`](docs/milestones/GB-M03-04-audit.md), and [`GB-M03-06`](docs/milestones/GB-M03-06-audit.md), plus atomic Echo package [`GB-M03-13`](docs/milestones/GB-M03-13-audit.md), are complete. Hosted CI [`29506273492`](https://github.com/MikeyPar/Gravebound/actions/runs/29506273492) is the final death/Echo acceptance. [`GB-M03-08`](docs/tasks/GB-M03-08.md) preserves old protocol bytes while appending extraction/Recall kinds `19`/`20`; extraction custody/writer/recovery/dispatch are hosted green through [`29521716146`](https://github.com/MikeyPar/Gravebound/actions/runs/29521716146); and the complete Recall writer/recovery plus immutable integration reset are hosted green through [`29529329817`](https://github.com/MikeyPar/Gravebound/actions/runs/29529329817). Exact tick coordination and actor-injected real-QUIC Start/Cancel dispatch are implemented, while migration `0058` now makes the explicit client tick durable canonical replay material so an altered request cannot become an exact replay after restart. Hosted run [`29531220086`](https://github.com/MikeyPar/Gravebound/actions/runs/29531220086) is validating that correction. Next, serialize Recall through a bounded character-actor mailbox, drive all five producers through one pinned terminal tick, execute or recover the stored winner, publish the protocol result plus Hall `(32,42)` projection under response loss, and implement minimum ResolutionHold operations. Then complete `GB-M03-07` successor recovery and parent `GB-M03-03`; keep normal route admission and Core promotion fail closed.
