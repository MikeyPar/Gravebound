...
> **Project status:** M01 and M02 are closed. GB-M03 is approximately **90% complete**. Identity, PostgreSQL persistence, Hall/private-world foundations, progression, the complete item/Vault lifecycle, Oath/Bargain, Ash, atomic death/Memorial/Echo persistence, extraction/Emergency Recall/ResolutionHold, and successor recovery are closed under hosted evidence. The active private-route integration now enters B6 through a route-bound Sir Caldus owner with continuous inherited danger ticks, exact loading/countdown/participant-lock/introduction timing, same-tick Phase 1 startup, atomic route projection, separate `0.70` body/`0.62` damage collision, and rollback-safe charge separation. Remaining work is full-fight closure, boss reward/pending-inventory and stable-exit composition, bound normal admission, telemetry/support/hosting packages, and final hosted/private-cohort/platform gates.
...
Commits `3c05a36`, `cdeceda`, `8efcec0`, `b61cbce`, `4eba061`, `c433cbd`, `f7f7fbb`, and `a9a17e0` now carry B5 authority into a route-bound B6 owner: exact compiled arena, player/combat/projectile identity, inherited 30 Hz tick, five-second countdown, immutable participant lock, resumable 75-tick introduction, same-tick Phase 1 encounter, legal early-phase defeat projection, stale-route rollback, separate `0.70` physical-body collision for walking/Slipstep, and deterministic post-charge separation are locally green. Commit `7669e41` supplies the separately verified unregistered transition pack; `a0a8390` and `fd5463f` supply the verified unregistered combat-presentation pack and exact native-review handoff. Next run the complete route-bound deterministic fight through phase breaks and defeat before composing committed boss reward/pending-inventory placement and the stable exit. Bound normal-server construction, hosted B3 adverse/restart proof, and normal admission remain disabled.
