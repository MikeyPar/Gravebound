...
> **Project status:** M01 and M02 are closed. GB-M03 is approximately **91% complete**. Identity, PostgreSQL persistence, Hall/private-world foundations, progression, the complete item/Vault lifecycle, Oath/Bargain, Ash, atomic death/Memorial/Echo persistence, extraction/Emergency Recall/ResolutionHold, and successor recovery are closed under hosted evidence. The active private-route integration now reaches deterministic Sir Caldus defeat through both breaks with continuous inherited danger ticks, atomic route projection, distinct body/damage collision, rollback-safe charge separation, hostile cleanup, and reset identity nonreuse. Remaining work is boss reward/pending-inventory and stable-exit composition, bound normal admission, telemetry/support/hosting packages, and final hosted/private-cohort/platform gates.
...
Commits `3c05a36`, `cdeceda`, `8efcec0`, `b61cbce`, `4eba061`, `c433cbd`, `f7f7fbb`, `a9a17e0`, and `c0af19d` now carry B5 authority through a complete route-bound B6 defeat: exact compiled arena, player/combat/projectile identity, inherited 30 Hz tick, countdown/lock/introduction, atomic route projection, separate body/damage collision, deterministic charge separation, both authored breaks, Phase 3, terminal hostile cleanup, byte-identical replay, and real projectile identity nonreuse after reset are locally green. Commit `7669e41` supplies the separately verified unregistered transition pack; `a0a8390` and `fd5463f` supply the verified unregistered combat-presentation pack and exact native-review handoff. Next compose the already-existing durable Caldus victory coordinator, pending-inventory placement, and reward-gated stable exit into this same route owner. Bound normal-server construction, hosted B3 adverse/restart proof, and normal admission remain disabled.
