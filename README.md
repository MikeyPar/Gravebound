...
[`GB-M03-04G`](docs/milestones/GB-M03-04G-audit.md), parent [`GB-M03-04`](docs/milestones/GB-M03-04-audit.md), and persistence slice [`GB-M03-02C`](docs/milestones/GB-M03-02C-audit.md) are complete. The active [`GB-M03-06A`](docs/tasks/GB-M03-06A.md)/[`GB-M03-02D`](docs/tasks/GB-M03-02D.md) slice now includes the schema-`0034`-`0036` V3 graph, the single-writer serializable crash-restore coordinator (`b4f6462`), and its production-entry hosted fixture (`6d8ab1a`) under accepted [`SPEC-CONFLICT-027`](docs/spec-conflicts/SPEC-CONFLICT-027-m03-crash-restore-completeness.md) and 64-identity correction [`SPEC-CONFLICT-028`](docs/spec-conflicts/SPEC-CONFLICT-028-m03-crash-baseline-identity-capacity.md). Run `29383589459` proved the repaired entry path in seven of eight cases and isolated one stale V1 test assertion; `aa21fbb` corrected that assertion without changing runtime behavior. Require exact-head run `29384786342` to pass the full schema-36 entry/recovery/replay/rollback gate. Once green, publish the crash-restore evidence handoff and begin strict death DTOs, clocks/trace authority, and the transactional death/Echo repository. Keep all player-visible death, successor, extraction/Recall, station admission, Core promotion, and normal-route behavior fail closed.
