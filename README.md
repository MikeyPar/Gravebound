...
Parents [`GB-M03-02`](docs/milestones/GB-M03-02-audit.md), [`GB-M03-04`](docs/milestones/GB-M03-04-audit.md), and [`GB-M03-06`](docs/milestones/GB-M03-06-audit.md), plus atomic Echo package [`GB-M03-13`](docs/milestones/GB-M03-13-audit.md), are complete. Hosted CI [`29506273492`](https://github.com/MikeyPar/Gravebound/actions/runs/29506273492) is the final death/Echo acceptance. [`GB-M03-08`](docs/tasks/GB-M03-08.md) preserves old protocol bytes while appending extraction/Recall kinds `19`/`20`; extraction custody/writer/recovery/dispatch are hosted green through [`29521716146`](https://github.com/MikeyPar/Gravebound/actions/runs/29521716146); the Recall writer/recovery and durable explicit client-tick replay identity are hosted green through [`29531220086`](https://github.com/MikeyPar/Gravebound/actions/runs/29531220086); and the bounded actor mailbox is hosted green through [`29531939971`](https://github.com/MikeyPar/Gravebound/actions/runs/29531939971). Commit `17a6c9e` adds the immutable full-snapshot pin, canonical five-producer driver, exact explicit/LinkLost death precedence, stored protocol/Hall publication, lineage-safe committed replay, and receipt-matched restart mailbox recovery; hosted run [`29534531389`](https://github.com/MikeyPar/Gravebound/actions/runs/29534531389) is validating that slice. Next, connect this driver to the active character tick owner and bounded session outbox so tick `12`/`90` pushes the committed `Stored` result and Hall `(32,42)` projection without another client request. Prove response loss, reconnect, restart, same-tick death, and cleanup through real QUIC plus PostgreSQL, then implement minimum ResolutionHold read/move/destroy recovery. After `GB-M03-08`, complete `GB-M03-07` successor recovery and parent `GB-M03-03`; keep normal route admission and Core promotion fail closed.
