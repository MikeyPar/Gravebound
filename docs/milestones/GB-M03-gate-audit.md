...
| `09` | Open | Terminal/onboarding/session/crash telemetry is committed-source backed, hosted schema-77 proof covers loot and terminal origins, and schema 78 implements atomic `TEL-003` death inputs locally; hosted schema-78 execution, bounded operational exporter integration, and destination/privacy/accuracy proof remain open. |
