...
| `09` | Open | Terminal/onboarding/session/crash telemetry is committed-source backed, schemas 71/72 have hosted immutable loot-origin proof, and schema 73 adds durable terminal origins; complete `TEL-003` death inputs, hosted schema-73 proof, enabled exporter integration, and accuracy/redaction proof remain open. |
