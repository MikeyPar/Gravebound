...
| Malformed or oversized input | `protocol::safe_inventory` validation tests; `protocol::codec::safe_inventory_framing_rejects_malformed_and_oversized_bytes` | invalid identity/hash/version/index/result shape, truncated bytes, and frames beyond 64 KiB fail before authority or mutation | Local pass; cumulative rerun pending |
